...
int (*call_vec[])(void) = {
	...
	do_publish,		/* 69 = topicpublish	*/
	do_retrieve,		/* 70 = topicretrieve	*/
	...
	no_sys,		/* 95 = (fchmod) */
	no_sys,		/* 96 = (fchown) */
	do_getPublishAccessOfTopic,		/* 97 = getPublishAccess */
	...
	do_topic_publisher,		/* 103 = topic_publisher */
	do_getprocnr,	/* 104 = getprocnr */
	do_topic_subscriber,		/* 105 = topic_subsriber */
	do_get,		/* 106 = issetugid */
	do_getepinfo_o,	/* 107 = getepinfo XXX: old implementation*/
	no_sys,		/* 108 = (utimens) */
	do_releaseSem,		/* 109 = releaseSem */
	no_sys,		/* 110 = unused */
